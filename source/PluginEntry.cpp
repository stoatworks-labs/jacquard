/**
	...
	`CFFGLPluginInfo` that Jacquard.cpp registers at static-initialisation time.
	...
	binary: which build it is.
		...
		strings Jacquard.bundle/Contents/MacOS/Jacquard | grep jacquard
*/

extern "C" const char* JacquardBuildStamp()
{
	return "jacquard " JACQUARD_VERSION " built " __DATE__ " " __TIME__;
}
