/*
 * Stoatworks Labs - About window data for Jacquard.
 *
 * PROVISIONAL, hand-written in the shape stoatworks-backend/scripts/sync-about.py
 * generates. Jacquard is not yet registered in the website's projects.json, so
 * the sync cannot produce this file; once it is, `sync-about.py --only
 * jacquard --apply` overwrites this with the generated copy. The facts below
...
{
    inline constexpr auto name = "Jacquard";
    inline constexpr auto slug = "jacquard";
    inline constexpr auto hook = "The picture woven on a jacquard loom, for Resolume";
