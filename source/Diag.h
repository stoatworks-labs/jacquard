...
/**
    ...
    **A pass buffer that could not be allocated.** This plugin holds one
    small float buffer (the cell means, at most 320 x 320), and the failure
    mode when the driver says no is a black frame with nothing to explain it.
    What goes in the log is the size asked for.
*/
namespace jacquard::diag
{
